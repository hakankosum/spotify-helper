...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (BuildContext context,GetNewRealeseProvider value, Widget? child) { return  Scaffold(
        body: (newRealeseSong!.isNewSongLoaded == false ||
                categories!.is_categories_loaded == false)
                            ...
                            prefixIcon: InkWell(
                                onTap: () async {
                                  if (mycontroller.text.isNotEmpty) {
                                    searchedArtist = await SearchArtistService(
                                        mycontroller.text);
